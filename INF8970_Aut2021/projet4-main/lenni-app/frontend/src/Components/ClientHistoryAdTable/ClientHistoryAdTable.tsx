...
interface ClientHistoryAdTableProps {
  setCurrentClientBoughtAds: React.Dispatch<React.SetStateAction<ITransactionData[]>>
  currentClientBoughtAds: ITransactionData[]
}

export default function ClientHistoryAdTable({ currentClientBoughtAds, setCurrentClientBoughtAds }: ClientHistoryAdTableProps) {
  ...
  const emptyRows = rowsPerPage - Math.min(rowsPerPage, currentClientBoughtAds.length - page * rowsPerPage)
      ...
      <TableTopContainer className={classes.paper}>
        ...
        <TableContainer>
          ...
          >
            ...
            />
            <TableBody>
              {stableSort(currentClientBoughtAds, getComparator(order, orderBy))
        ...
        <TablePagination
          ...
          component="div"
          count={currentClientBoughtAds.length}
