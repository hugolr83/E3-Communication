...
interface ClientHistoryExchangeTableProps {
  setCurrentClientExchanges: React.Dispatch<React.SetStateAction<IExchangeData[]>>
  currentClientExchanges: IExchangeData[]
}

export default function ClientHistoryExchangeTable({ currentClientExchanges, setCurrentClientExchanges }: ClientHistoryExchangeTableProps) {
  ...
  const emptyRows = rowsPerPage - Math.min(rowsPerPage, currentClientExchanges.length - page * rowsPerPage)
      ...
      <TableTopContainer className={classes.paper}>
        ...
        <TableContainer>
          ...
          >
            ...
            />
            <TableBody>
              {stableSort(currentClientExchanges, getComparator(order, orderBy))
        ...
        <TablePagination
          ...
          component="div"
          count={currentClientExchanges.length}
